$(document).ready(function()
{
    ...
    var div="";
    console.log(fileObj.diff.length);

    for (var i = fileObj.diff.length - 1; i >= 0; i--) {
        var content='<li class="image_li"><span class="glyphicon glyphicon-chevron-down arrow"> </span><span>'+ fileObj.diff[i].split(".")[0] +'</span> </li>';
        div+=content;
    }
    ...
    {
        $(".icon1").addClass("icon2").removeClass("icon1").removeClass("glyphicon glyphicon-search");
        $(".inp").val("");
    ...
    $(".tab_li2").click(function()
    {
        ...
        $(".icon2").addClass("icon1").addClass("glyphicon glyphicon-search").removeClass("icon2");
    })
    ...
    $(document).on("click",'.image_li',function()
    {
        ...
        else
        {
            ...
            var image_view = '<div class="img_div_hide" ><span class="span"><span class="title" >Original Image</span><img class="scr_img" src="./../../../../screenShots/my_ui_reference/'+ name +'.png"></img></span><span class="span"> <span class="title" >Tested Image</span><img class="scr_img" src="./../../../../screenShots/my_ui_test/'+ name +'.png"></img></span><span class="span" > <span class="title">Difference Image</span><img class="scr_img" src="./../../../../screenShots/my_ui_diff/'+ name+'.png"></img></span><span class="refer span"><h4>Referencedby</h4><ul class="refer_ul"></ul><span class="message"></span></span></div>';
