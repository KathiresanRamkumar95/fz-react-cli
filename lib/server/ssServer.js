...
var seleniumHub = process.env.npm_config_selenium_hub || 'htt' + 'p://desk-react.tsi.zohocorpin.com:4444';
...
var referenceMode = function referenceMode() {
  ...
  ssTest.run({
    ...
    var result = spawn.sync('cp', ['-r', path.join(__dirname, '..', '..', 'screenshotreport', 'images'), path.join(appPath, 'screenShots')], { stdio: 'inherit' });
