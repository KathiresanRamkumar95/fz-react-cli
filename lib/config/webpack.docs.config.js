...
var className = cssUnique ? '[name]__[local]__[hash:base64:5]' : '[name]__[local]';
...
module.exports = {
  entry: {
    main: ['babel-polyfill', path.join(appPath, componentPath || 'src', 'index.js')],
  ...
  plugins: [new webpack.ProvidePlugin({
    React: 'react'
  }), new CaseSensitivePathsPlugin(), new webpack.optimize.CommonsChunkPlugin({
    name: 'vendor',
    filename: 'vendor.js'
