...
module.exports = {
  entry: {
    main: [require.resolve('../hmrClient'), 'babel-polyfill', require.resolve('../wmsClient'), require.resolve('react-error-overlay'), path.join(appPath, appFolder, mig ? 'migration.js' : 'index.js')]
  },
